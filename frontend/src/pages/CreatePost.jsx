...
const CreatePost = () => {
    ...
    const handleCreate = async (e) => {
        ...
        if (file) {
            ...
            // console.log(post);
            try {
                const imgUpload = await axios.post("https://test-jq16.onrender.com/api/upload", data)
        ...
        // console.log(post)
        try {
            const res = await axios.post("https://test-jq16.onrender.com/api/posts/create", post, { withCredentials: true })
